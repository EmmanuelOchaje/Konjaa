...
const Navbar = () => {
  ...
  return (
    <div>
      ...
      >
        <span className="float-right mr-8 mt-10 text-5xl text-black">
          <i class="bx bx-x" onClick={() => showMenu()}></i>
        </span>
        <ul className="mx-4 mt-12 my-">
          <li className="text-[#777777] text-[18px] mb-8 mr-8 font-normal">
            <Link to="/">Home</Link>
          </li>
          <li className="text-[#777777] text-[18px] mb-8 mr-8 font-normal">
          ...
          <li className="text-[#777777] text-[18px] mb-8 font-normal">
            Partners
          </li>
      ...
      <div className="flex justify-between lg:pt-8 py-4 px-2 lg:px-[6rem] items-center">
        <img src={logo} className="w-50 cursor-pointer h-12" alt="Pontify" />
        ...
        <div>
          ...
          <span className="float-right lg:hidden mr-6 mt-6 text-5xl text-black">
