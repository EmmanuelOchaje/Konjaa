...
const Content = (props) => {
  return (
    <div className="py-8 px-4 lg:px-[6rem]">
      ...
      <h3 className="mt-2 text-[20px] font-bold md:ml-3 py-2 md:pb-5 text-[#8870c4]">
      ...
      <p className="px-2 md:px-5 text-[16px] font-medium">
        ...
        <span className="font-medium text-[#8870c4]">Konjaa.com</span> POS
        system.
      </p>
      <p className="px-2 md:px-5 text-[16px] font-medium">
        1.2 Transaction Data:{" "}
        <span className="font-medium text-[#8870c4]">Konjaa.com</span> may
      ...
      <p className="px-2 md:px-5 text-[16px] font-medium">
        ...
        <span className="font-medium text-[#8870c4]">Konjaa.com</span> may share
        information with trusted third-party partners for the purpose of
      ...
      <p className="px-2 md:px-5 text-[16px] font-medium">
        ...
        <span className="font-medium text-[#8870c4]">Konjaa.com</span> employs
      ...
      <p className="px-2 md:px-5 text-[16px] font-medium">
        ...
        <span className="font-medium text-[#8870c4]">Konjaa.com</span> platform.
