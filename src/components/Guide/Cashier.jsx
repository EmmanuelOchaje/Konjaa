  ...
  return (
    <div className="mx-5 py-5">
      ...
      <p className="text-black py-5 leading-6">
        Konjaa allows an Admin (shop owner) to add cashiers, edit their details,
        give and deny permission, as well as delete cashiers. The actions of
        cashiers are entirely controlled the shop owner – follow the steps below
